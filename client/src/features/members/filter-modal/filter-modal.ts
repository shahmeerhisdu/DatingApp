...
export class FilterModal {
  ...
  memberParams = model(new MemberParams());  //we have used the model here becuase we are setting the memberParams inside the contructor based on the local storage data.
